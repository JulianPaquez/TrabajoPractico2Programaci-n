...
class Estudiante(Usuario):
    ...
    def ValidarIngresoEstudiante(self):
        ...
        vali = vali.ValidarUsuario(emailEstudiante,Personas(Estudiante1,Estudiante2,Estudiante3,Estudiante4))
        vali2 = vali2.ValidarUsuarioCoontr(ContrEstudiante,emailEstudiante,Personas(Estudiante1,Estudiante2,Estudiante3,Estudiante4))
        if vali == 1 and vali2 == 1:
            return "Ha accedido al sistema"
        elif vali == 1 and vali2 == 0:
            print ("La contraseña ingresada es incorrecta. ")
        elif vali == 0 and vali == 1:
...
Estudiante2 = Estudiante("Pedro", "Gomez", "pedrogomez@gmail.com", "pedro123")
Personas.append(Estudiante2)

Estudiante3 = Estudiante("Julian", "Perez", "julianperez@gmail.com", "juli123")
Personas.append(Estudiante3)

Estudiante4 = Estudiante("Martin", "Lopez", "martinlopez@gmail.com", "martin123")
Personas.append(Estudiante4)
